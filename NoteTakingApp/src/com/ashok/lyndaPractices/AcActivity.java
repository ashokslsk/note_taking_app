...
import com.ashok.lyndaPractices.data.NotesDataSource;
...
public class AcActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent intent = new Intent(this,NoteEditorAcitivity.class);
